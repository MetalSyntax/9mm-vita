...
// Symbols the game imports that the default table doesn't cover.
// unlockpt/ptsname: POSIX pty stuff, nothing here ever calls them.
static int getuid_9mm(void) { return 0; }
static int mprotect_9mm(void *addr, size_t len, int prot) { return 0; } // pretend it worked
static int unlockpt_9mm(int fd) { return 0; }
static char *ptsname_9mm(int fd) { return NULL; }
static ssize_t readlink_9mm(const char *path, char *buf, size_t sz) { return -1; }

// --- 9mm boot 5 (libCopStory principal) : exceptions C++, helpers flottants, divers ---
// libgcc already provides the __aeabi_* and _Unwind_* helpers.
extern void *__aeabi_fcmpeq, *__aeabi_fcmpun, *__aeabi_fcmpgt, *__aeabi_d2f, *__aeabi_dcmpeq, *__aeabi_f2d;
extern void *_Unwind_GetLanguageSpecificData, *_Unwind_Resume, *_Unwind_RaiseException,
            *_Unwind_DeleteException, *_Unwind_GetRegionStart, *_Unwind_GetTextRelBase,
            *_Unwind_VRS_Get, *_Unwind_VRS_Set, *_Unwind_GetDataRelBase,
            *_Unwind_Resume_or_Rethrow, *_Unwind_Complete;
extern void *__dso_handle;
// inet_addr comes from arpa/inet.h, referenced as is
struct iovec_9mm { void *iov_base; size_t iov_len; };
static ssize_t writev_9mm(int fd, const struct iovec_9mm *iov, int cnt) {
    ssize_t total = 0;
    for (int i = 0; i < cnt; i++) {
...
static int uname_9mm(void *buf) { if (buf) sceClibMemset(buf, 0, 390); return 0; } // utsname bionic ~390o, champs vides

so_default_dynlib default_dynlib[] = {
        // --- 9mm : ajouts 1er boot ---
        { "getuid",   (uintptr_t)&getuid_9mm },
        { "readlink", (uintptr_t)&readlink_9mm },
        { "mprotect", (uintptr_t)&mprotect_9mm },
        { "unlockpt", (uintptr_t)&unlockpt_9mm },
        { "ptsname",  (uintptr_t)&ptsname_9mm },
        { "clearerr", (uintptr_t)&clearerr },
        // --- 9mm : ajouts boot 5 (jeu libCopStory) ---
        ...
        { "uname",     (uintptr_t)&uname_9mm },
        { "writev",    (uintptr_t)&writev_9mm },
        ...
        { "access", (uintptr_t)&access_soloader }, // 9mm : remap Gloft9MHM/ -> DATA_PATH
        ...
        { "dlopen", (uintptr_t)&ret0 }, // 9mm: ret1(0x1) faisait crasher hook_import_function ; NULL = chemin propre
